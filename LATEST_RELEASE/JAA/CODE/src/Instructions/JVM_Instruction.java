...
public class JVM_Instruction extends Instruction {
    public enum JVM_Mnemonic{iadd,iload,iload_0,iload_1,iload_2,iload_3,iconst_m1,iconst_0,iconst_1,iconst_2,iconst_3,iconst_4,iconst_5,istore,istore_0,istore_1,istore_2,istore_3,ret}
    private Arch arch;
    ...
    static
    {
        ...
        Mnemonic_to_Opcode.put(JVM_Mnemonic.ret,0xb1);
        Opcode_to_Mnemonic.put(0xb1,JVM_Mnemonic.ret);
    }
